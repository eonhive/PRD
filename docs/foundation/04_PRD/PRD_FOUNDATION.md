...
- manuals
- white papers
- serialized prose-led reading docs
...
Novels and web novels currently belong inside this family unless later canon promotes a more specialized profile.
...
- manhua-style and manhwa-style serial comics
- possible episode/chapter packaging

Manhua and manhwa currently belong inside the `comic` family unless later canon promotes a more specialized profile or variant model.
...
- required package identity/opening fields remain at the top level
- optional durable references may live in `identity`
- lean reader-facing metadata may live in `public`
- rich about/creator/series material should live in content or other non-manifest payloads
...
- declared extensions
- compatibility requirements
- visible metadata intended for normal readers/viewers, such as byline, summary, rating, or cover reference
...
Short discovery and display metadata may remain public. Rich author bios, about pages, and long editorial notes should stay in content or other non-manifest payloads unless a later higher-priority spec defines a narrower shared model.
