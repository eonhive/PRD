...
Novels and web novels currently belong inside the `general-document` family. Manhua and manhwa currently belong inside the `comic` family unless later canon promotes a more specialized profile or variant model.
...
General reading forms such as articles, reports, resumes, portfolios, manuals, novels, web novels, and similar prose-led documents belong inside the `general-document` family unless later canon promotes them separately.
Manhua and manhwa-style works currently belong inside the `comic` family unless later canon promotes a more specialized profile or variant model.
...
Short creator, publisher, summary, genre, rating, or cover metadata may live in the manifest.
Rich author bios, about pages, acknowledgements, and long release notes should stay in content or later profile-specific payloads.
