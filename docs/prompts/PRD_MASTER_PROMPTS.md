...
- `docs/foundation/04_PRD/PRD_DECISIONS.md`
...
- `docs/core/PRD_LOCALIZATION_MODEL.md` when localization, language, locale, or text-direction behavior is relevant

Every PRD prompt should follow `docs/governance/PRD_PROMPT_DOCTRINE.md` for source-of-truth precedence, prompt constraints, labeled assumptions, incomplete-doc handling, and forbidden behaviors.
...
Rules:
- Follow docs/governance/PRD_PROMPT_DOCTRINE.md for source precedence, labeled assumptions, incomplete-doc handling, and forbidden behaviors.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_MINIMAL_VALID_SPEC.md`.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_MANIFEST_DRAFT.md`.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_PACKAGE_LAYOUT_DRAFT.md`.
...
```text
Using the canonical PRD docs, write `docs/profiles/PRD_PROFILE_GENERAL_DOCUMENT.md`.
...
```text
Using the canonical PRD docs, write `docs/profiles/PRD_PROFILE_COMIC.md`.
...
```text
Using the canonical PRD docs, write `docs/profiles/PRD_PROFILE_STORYBOARD.md`.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_ASSETS_AND_ATTACHMENTS.md`.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_LOCALIZATION_MODEL.md`.
...
```text
Using the canonical PRD docs, write `docs/core/PRD_VERSIONING_POLICY.md`.
...
```text
Using the canonical PRD docs, write `docs/product/PRD_PRODUCT_BOUNDARIES.md`.
...
```text
Using the canonical PRD docs, write `docs/extensions/PRD_PROTECTION_MODEL.md`.
