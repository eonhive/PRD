...
* `pnpm release:preflight` to verify npm token auth, `eonhive` org membership, target package names, and whether the release is in first-preview bootstrap mode or normal versioned-release mode
